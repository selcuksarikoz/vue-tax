      ...
      <v-row>
        ...
        <v-col cols="12" md="6">
          ...
          <v-text-field
            ...
            maxlength="11"
            :rules="[
              (tax.noTaxId as boolean) ||
                !!tax.taxId ||
                'Tax ID is required if not disabled',
            ]"
            variant="outlined"
            density="comfortable"
            class="mt-4"
        ...
        <v-col cols="12" md="6">
          ...
          <v-text-field
            ...
            maxlength="12"
            :rules="[
              (insurance.noSsn as boolean) ||
                !!insurance.ssn ||
                'SSN is required if not disabled',
            ]"
            variant="outlined"
            density="comfortable"
            class="mt-4"
          ...
          <v-text-field
            ...
            class="mt-4"
            @update:model-value="
              updateInsuranceField('healthInsuranceType', $event)
            "
          />
          <v-text-field
            ...
            class="mt-4"
            @update:model-value="
              updateInsuranceField('healthInsurance', $event)
            "
          />
          <v-text-field
            ...
            required
            :rules="[
              (v) => !!v || 'Desired health insurance company is required',
            ]"
            variant="outlined"
            density="comfortable"
            class="mt-4"
            @update:model-value="
              updateInsuranceField('desiredHealthInsuranceCompany', $event)
            "
          />
          <v-text-field
            ...
            class="mt-4"
            @update:model-value="
              updateInsuranceField('privateHealthInsuranceName', $event)
            "
          />
          <v-text-field
            :model-value="
              insurance.privateHealthInsuranceContribution as string
            "
            label="Private health insurance contribution"
            required
            :rules="[
              (v) => !!v || 'Private health insurance contribution is required',
            ]"
            variant="outlined"
            density="comfortable"
            class="mt-4"
            @update:model-value="
              updateInsuranceField('privateHealthInsuranceContribution', $event)
            "
          />
          <v-text-field
            :model-value="
              insurance.privateNursingInsuranceContribution as string
            "
            label="Private nursing insurance contribution"
            required
            :rules="[
              (v) =>
                !!v || 'Private nursing insurance contribution is required',
            ]"
            variant="outlined"
            density="comfortable"
            class="mt-4"
          ...
          <v-text-field
            ...
            class="mt-4"
            @update:model-value="
              updateInsuranceField('lastPrivateHealthInsurance', $event)
            "
          />
          <v-switch
            ...
            class="mt-4"
            @update:model-value="
              updateInsuranceField('requestFromPensionInsurance', $event)
            "
          />
          <v-radio-group
 ...
 */
const tax = computed(
  () => (props.formData.tax as Record<string, unknown>) || {}
)
const insurance = computed(
  () => (props.formData.insurance as Record<string, unknown>) || {}
)
